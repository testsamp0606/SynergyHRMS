      ...
      <main className="flex flex-1 flex-col gap-4 p-4 md:gap-8 md:p-8">
        <Card className="lg:col-span-4">
            <CardHeader className="flex flex-row items-center">
                ...
                <Button size="lg" className="ml-auto gap-1">
              ...
              <TableBody>
                {payrollRuns.map(run => (
                  <TableRow key={run.id}>
                    ...
                    <TableCell>{format(run.runDate, 'MMMM d, yyyy')}</TableCell>
                    <TableCell>
                    ...
                    <TableCell className="text-right">{currencyFormatter.format(run.totalAmount)}</TableCell>
